...
cp -r media/youtube-content ~/.hermes/skills/media/youtube-content/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/youtube-content-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/youtube-content-skill.git ~/.hermes/skills/media/youtube-content/
```
...
```text
skill_view(name="media/youtube-content")
```
...
```text
Use the youtube content skill to <describe your specific task here>
```
...
```text
Gunakan skill youtube content untuk <deskripsikan tugas spesifik Anda di sini>
```
